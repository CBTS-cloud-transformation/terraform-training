...
5. **Automatic Inclusion**: Files named `terraform.tfvars` or `*.auto.tfvars` are automatically loaded when `terraform` is run. Other files would need to be passed using the -var-file flag.
